...
def run_test_polygon():
    ...
    title = 'POLYGON test 3:  7 segments with thick red lines.'
    window = rg.RoseWindow(500, 500, title)

    circle = rg.Circle(rg.Point(250, 250), 200)
    circle.outline_thickness = 5
    polygon(window, circle, 7, 'red', 10)
    window.continue_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  50 black lines on red circle, hops = 13.'
    window = rg.RoseWindow(500, 500, title)

    circle = rg.Circle(rg.Point(250, 250), 200)
    circle.fill_color = 'red'
    fancy_polygon(window, circle, 50, 13, 'black', 5)
    window.close_on_mouse_click()
